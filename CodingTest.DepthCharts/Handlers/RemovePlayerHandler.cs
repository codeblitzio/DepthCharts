...
public class RemovePlayerHandler : IRequestHandler<RemovePlayerCommand, Unit>
{
    ...
    public async Task<Unit> Handle(RemovePlayerCommand command, CancellationToken cancellationToken)
    {
